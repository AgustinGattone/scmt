...
urlpatterns = [
    ...
    url(r'^oferta/$', core_views.listar_ofertas, name='oferta'),
    url(r'^eliminar/(?P<pk>[0-9]+)/oferta$', core_views.oferta_delete, name='oferta_delete'),
    url(r'^oferta/(?P<pk>[0-9]+)/edit$', core_views.oferta_edit, name='oferta_edit'),
